...
def build():
    ...
    # Hashed over the bytes, not the mtimes. A modification time changes when
    # a file is copied or checked out and stays put when content is restored,
    # so it answered "was this file touched" where the only useful question is
    # "is this file different" — every rebuild churned the cache name and
    # every visitor re-downloaded a shell that had not changed.
