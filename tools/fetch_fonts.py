...
def main():
    ...
    blocks = [
        ...
        "",
        "/* Fallback faces with the real ones' metrics. font-display: swap means",
        "   a slow connection shows the system serif first; without these the",
        "   page then jumps when the webfont lands. Both families measure ~87%",
        "   of Georgia's width at the same size — re-measure by rendering the",
        "   same string in each and comparing widths. */",
        "@font-face {",
